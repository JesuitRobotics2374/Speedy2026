...
public class Telemetry {
    ...
    private final StructPublisher<ChassisVelocities> driveVelocities = driveStateTable.getStructTopic("Velocities", ChassisVelocities.struct).publish();
    ...
    private final MechanismLigament2d[] m_moduleVelocities = new MechanismLigament2d[] {
    ...
    public void telemeterize(SwerveDriveState state) {
        ...
        driveVelocities.set(state.Velocity);
        ...
        for (int i = 0; i < 4; ++i) {
            m_moduleVelocities[i].setAngle(state.ModuleVelocities[i].angle);
            m_moduleDirections[i].setAngle(state.ModuleVelocities[i].angle);
            m_moduleVelocities[i].setLength(state.ModuleVelocities[i].velocity / (2 * MaxSpeed));
