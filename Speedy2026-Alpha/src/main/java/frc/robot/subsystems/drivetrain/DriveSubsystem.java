...
public class DriveSubsystem extends TunerSwerveDrivetrain implements Subsystem {
    ...
    public DriveSubsystem(
        ...
        //         this::getCurrentRobotChassisVelocities, // ChassisVelocities supplier. MUST BE ROBOT RELATIVE
        //         (speeds, feedforwards) -> SwerveDrivetrain.drive(
        //                 speeds,
        //                 SwerveDriveKinematics.toSwerveModuleVelocities(speeds),
    ...
    public ChassisVelocities getCurrentRobotChassisVelocities() {
        return getKinematics().toChassisVelocities(getState().ModuleVelocities);
    }
